...
function statusChangeIcon(status,taskId) {
  ...
  if(status == "start") {
    path = "background-image: url(&quot;../images/sprite/5-pourcent/en-cours/encours";
  }
  if(status == "pause") {
  ...
  if(status == "stop"){
    path = "background-image: url(&quot;../images/sprite/fini/fini";
  }
  ...
  if(status == "start") {
    path = "data-baseurl=\"../images/sprite/5-pourcent/en-cours/encours";
  }
  if(status == "pause") {
    path = getIconBasePath(baseURL)+"pause/pause" ;
  }
  ...
  if(status == "stop"){
    path = "data-baseurl=\"../images/sprite/fini/fini";
  }
