...
$(document).ready(function(){
	...
	$("li.ligne-liste.ready").each(function(index) {
	  if ($(".ligne-clic .case",this).css("background-color")=="rgb(255, 255, 255)") {
	  	$(".ligne-clic .statut .case-content .picto-statut",this).first().attr("data-baseurl","../images/sprite/ready/ready");
	  	$("#bloc-content #content ul.liste-elements li.ligne-liste.ready .case.statut .picto-statut").spriteanim();
	  }else{
	  	$(".ligne-clic .statut .case-content .picto-statut",this).first().attr("data-baseurl","../images/sprite/ready/readyt");
	  	$("#bloc-content #content ul.liste-elements li.ligne-liste.ready .case.statut .picto-statut").spriteanim();
	  }
	});
